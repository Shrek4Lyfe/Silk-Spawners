...
execute as @a[scores={sp_holdSilk=0},nbt={SelectedItem:{id:"minecraft:golden_pickaxe",tag:{Enchantments:[{id:"minecraft:silk_touch"}]}}}] run scoreboard players set @s sp_holdSilk 1
execute as @a[scores={sp_holdSilk=1},nbt=!{SelectedItem:{id:"minecraft:golden_pickaxe",tag:{Enchantments:[{id:"minecraft:silk_touch"}]}}}] run scoreboard players set @s sp_holdSilk 0
